...
class _SettingsState extends State<Settings> {
  ...
  Color headerColor =
      ColorManager().headerColor; // Mengambil warna dari ColorManager
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                trailing:
                    headerColor == Colors.blue ? const Icon(Icons.check) : null,
              ),
              ListTile(
                ...
                trailing:
                    headerColor == Colors.red ? const Icon(Icons.check) : null,
              ),
              ListTile(
                ...
                trailing: headerColor == Colors.green
              ...
              ListTile(
                ...
                trailing: headerColor == Colors.yellow
                    ? const Icon(Icons.check)
                    : null,
              ),
              ListTile(
                ...
                trailing: headerColor == Colors.orange
                    ? const Icon(Icons.check)
                    : null,
              ),
